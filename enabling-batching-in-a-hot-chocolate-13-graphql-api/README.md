...
[![YouTube](https://img.youtube.com/vi/OZTtHWnYAJ4/0.jpg)](https://www.youtube.com/watch?v=OZTtHWnYAJ4)
...
1. Generate a self-signed certificate.
    ...
    ```
    ```shell
    openssl pkcs12 -export -in localhost.crt -inkey localhost.key -out localhost.pfx -name "Enabling Batching in a Hot Chocolate 13 GraphQL API"
    ```
