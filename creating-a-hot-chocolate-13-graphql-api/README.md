...
[![YouTube](https://img.youtube.com/vi/vxYcH122V88/0.jpg)](https://www.youtube.com/watch?v=vxYcH122V88)
...
1. Generate a self-signed certificate.
    ...
    ```
    ```shell
    openssl pkcs12 -export -in localhost.crt -inkey localhost.key -out localhost.pfx -name "Creating a Hot Chocolate 13 GraphQL API"
    ```
