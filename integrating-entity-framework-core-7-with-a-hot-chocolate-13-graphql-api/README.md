...
[![YouTube](https://img.youtube.com/vi/-BoO9P9KQF0/0.jpg)](https://www.youtube.com/watch?v=-BoO9P9KQF0)
...
1. Generate a self-signed certificate.
    ...
    ```
    ```shell
    openssl pkcs12 -export -in localhost.crt -inkey localhost.key -out localhost.pfx -name "Integrating Entity Framework Core 7 with a Hot Chocolate 13 GraphQL API"
    ```
