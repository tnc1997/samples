...
[![YouTube](https://img.youtube.com/vi/ARtzAdPSKac/0.jpg)](https://www.youtube.com/watch?v=ARtzAdPSKac)
...
1. Generate a self-signed certificate.
    ...
    ```
    ```shell
    openssl pkcs12 -export -in localhost.crt -inkey localhost.key -out localhost.pfx -name "Adding FIDO2-Related Mutations to a Hot Chocolate 13 GraphQL API"
    ```
