...
[![YouTube](https://img.youtube.com/vi/an0Dlltfl1I/0.jpg)](https://www.youtube.com/watch?v=an0Dlltfl1I)
...
1. Generate a self-signed certificate.
    ...
    ```
    ```shell
    openssl pkcs12 -export -in localhost.crt -inkey localhost.key -out localhost.pfx -name "Adding Data Loaders to a Hot Chocolate 13 GraphQL API"
    ```
