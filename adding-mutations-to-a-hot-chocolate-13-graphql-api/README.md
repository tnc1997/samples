...
[![YouTube](https://img.youtube.com/vi/Z5t7Jtth88o/0.jpg)](https://www.youtube.com/watch?v=Z5t7Jtth88o)
...
1. Generate a self-signed certificate.
    ...
    ```
    ```shell
    openssl pkcs12 -export -in localhost.crt -inkey localhost.key -out localhost.pfx -name "Adding Mutations to a Hot Chocolate 13 GraphQL API"
    ```
